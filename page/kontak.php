...
<html lang="en">
  <head>
    ...
    <nav class="navbar fixed-top navbar-dark navbar-expand-md justify-content-md-center justify-content-start">
      ...
      <img
        src="https://i.imgur.com/HjIOR0A.jpeg" alt="Gambar Beranda" style="width: 100%"/>
      <div style="color: #fff; position: absolute; top: 40%; left: 20%;">
          <h1>Kontak Kami</h1>
          <br>
          <h4>Nomor Telepon : +62 812-1111-1111<h4>
          <br>
          <h4>Email         : dummywebuajy@gmail.com<h4>
        </div>
