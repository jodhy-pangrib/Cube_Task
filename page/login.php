<?php
  ...
  if(isset($_SESSION['isLogin'])) {
    ...
    if(isset($_GET['token'])) {
      include ('../db.php');
      $token = $_GET['token'];
      $result = mysqli_query($con, "SELECT token,verifikasi FROM users WHERE verifikasi=0 AND token = '$token' LIMIT 1");
      if($result->num_rows == 1) {
        ...
        echo
          '<script>
          alert("Your Account Has Been Verified!"); window.location = "login.php"
          </script>';
      } else {
  ...
  <nav class="navbar fixed-top navbar-dark navbar-expand-md justify-content-md-center justify-content-start">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarScroll">
          ...
          <ul class="nav navbar-nav flex-row justify-content-md-center justify-content-start flex-nowrap"></ul>
              <form class="d-flex">
                  <button type="button" class="btn btn-outline-primary" style="color: #f0f0f0;">
                      LOGIN
                  </button>
              </form>
          </ul>
    ...
    <div class="container v-100 d-flex align-items-center justify-content-center" style="margin-top: 100px; margin-bottom: 100px;">
      <div class="card text-dark bg-light ma-5 shadow " style="min-width: 25rem;">
        <div class="card-header fw-bold fs-5">LOGIN</div>
        <div class="card-body">
          <form action="../process/loginProcess.php" method="POST">
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end"">
              <a class="btn btn-primary me-md-2" href="register.php">REGISTER</a>
