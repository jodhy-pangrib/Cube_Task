...
<html lang="en">
  ...
  <body>
          ...
          <ul class="nav navbar-nav flex-row justify-content-md-center justify-content-start flex-nowrap"></ul>
            <form class="d-flex">
              <button type="button" class="btn btn-outline-primary" style="color: #f0f0f0;">
                <a class="text-light" style="text-decoration: none" href="login.php">LOGIN</a>
              </button>
            </form>
          </ul>
        </div>
    ...
    <div class="container v-100 d-flex align-items-center justify-content-center" style="margin-top: 80px;">
      <div class="card text-dark bg-light ma-5 shadow " style="min-width: 25rem;">
      <div class="card-header fw-bold fs-5">REGISTER</div>
        <div class="card-body">
