...
<html lang="en">
  ...
  <nav class="navbar fixed-top navbar-dark navbar-expand-md justify-content-md-center justify-content-start">
    ...
    <div class="container v-100 d-flex align-items-center justify-content-center" style="margin-top: 80px; margin-bottom: 100px;">
      <div class="card text-dark bg-light ma-5 shadow " style="min-width: 25rem;">
        <div class="card-header fw-bold fs-5">Ganti Password</div>
        <div class="card-body">
          <form action="<?php echo '../process/editProfilProcess.php?id='.$data['id'].'' ?>" method="POST">
            <div class="mb-3">
